            ...
            <div className="tt-offcanvas-wrapper">
                <div className={`tt-offcanvas ${isActive ? "opened" : ""}`}>
                    ...
                    <div className="logo-box">
                        <Link href="/" aria-label="logo image"><img src="/assets/images/resources/logo-1.png"
                            width="155" alt="" /></Link>
                    </div>
                    ...
                    <ul className="mobile-nav__contact list-unstyled">
                        <li>
                            ...
                            <a href="mailto:sales@compressindia.in">sales@compressindia.in</a>
                        </li>
                        <li>
                            <i className="fa fa-phone-alt"></i>
                            <a href="tel:+91 8655011465">+91 8655011465</a>
                        </li>
                    </ul>
