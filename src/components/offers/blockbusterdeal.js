              ...
              <div className="bg-white px-6 py-12 md:px-16 md:py-20">
                <div className="max-w-7xl mx-auto" style={{ paddingBottom: '40px' }}>
                  <div className="wp-block-columns is-layout-flex wp-container-core-columns-is-layout-1 wp-block-columns-is-layout-flex">
                    ...
                    <div className="offers">
                      ...
                      <div className="col-xl-6">
                        <h3 className="text-xl font-semibold mb-4 text-gray-800"><strong>YEARLY SERVICE CONTRACT :</strong></h3>
                      ...
                      <div className="col-xl-6">
                        ...
                        <ul className="text-gray-700 space-y-2">
                          <li className="text-green-600">›› <span className="text-gray-700">Free call attend for water leakage issues.</span></li>
                          <li className="text-green-600">›› <span className="text-gray-700">Free call attend for wiring short circuit issues.</span></li>
                    ...
                    <div className="offers">
                      ...
                      {/* Benefits */}
                      <div className="col-xl-6">
                        <h3 className="text-xl font-semibold mb-4 text-gray-800"><strong>NOT COVERED :</strong></h3>
                        <ul className="text-gray-700 space-y-2">
                          <li className="text-green-600">›› <span className="text-gray-700">Parts Purchasing Failure of Compressor, Circuit board, fan motor, contactor & switch gears etc. </span></li>
                          ...
                          <li className="text-green-600">›› <span className="text-gray-700">Damage of Insulation on Communication & Power cables & Copper tubes/Pipe etc. </span></li>
                          <li className="text-green-600">
                            ›› <span className="text-gray-700 font-semibold">
                              Natural damages will not considered in this format. Please read all the specifications & technical details carefully before selection of the contracts.
                            </span>
                          </li>
                        </ul>
                      </div>
                  ...
                  <div>
                    ...
                    <h6 className="text text-center">This is a NON-AMC CONTRACT (service contract) offer so any breakdown of machines will not be covered in this format.</h6>
                  </div>
