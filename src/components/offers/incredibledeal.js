                                            ...
                                            <div className="w-full xl:w-1/2 px-4">
                                                ...
                                                <ul className="space-y-3 text-base text-gray-700">
                                                    <li className="flex items-start">
                                                        ...
                                                        <span>All Components / parts / switch gears will be covered from our side. Unlimited call attend for water leakage issues.</span>
                                                    </li>
                                                    <li className="flex items-start">
                                                        <span className="text-green-600 mr-2">››</span>
                                                        <span>No need to pay a single penny.</span>
                                                    </li>
                                                    <li className="flex items-start">
                                                        <span className="text-green-600 mr-2">››</span>
                                                        <span>After inspection of machines, rates of the contract will be extremely cheapest compared to market rates.</span>
                                                    </li>
                                                    <li className="flex items-start">
                                                        <span className="text-green-600 mr-2">››</span>
