...
export default function compressorinstallationPageOne() {
    return (
        <>
            <SEO pageTitle={"compressor-installation"} />
            <HeaderOne />
            <Breadcrumb
                    ...
                    <div className="row">
                        <div className="innerpage-whiteboxs main-timeline">
                            <div className="text-center mb-12" style={{ paddingBottom: '60px' }}>
                                ...
                                <h2 className="text-3xl font-bold">COMPRESSOR INSTALLATION SERVICES</h2>
                                <p className="text-gray-600 mt-2">Compressor Replacement ! Process of supply & installation of the (USED) compressor in Air conditioner</p>
                            </div>
                            <div>
                                <Onetimeservice />
                                <div className="mb-12 text-center italic" style={{ paddingTop: '60px', fontSize: 'small' }}>
                                    <h6>
                                        DISCAILMER : This is only Compressor replacement charges , If breakdown / repair required rates may vary as per standard charges in the market
                                    </h6>
                                </div>
                            </div>
                        </div>
