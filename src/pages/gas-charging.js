                    ...
                    <div className="row">
                        <div className="innerpage-whiteboxs main-timeline">
                            <div className="text-center mb-12" style={{ paddingBottom: '60px' }}>
                                ...
                                <p className="text-gray-600 mt-2">Gas Charging ! Process of filling the gas in the Air conditioner</p>
                            </div>
                            <div>
                                <Onetimeservice />
                                <div className="mb-12 text-center italic" style={{ paddingTop: '60px', fontSize: 'small' }}>
                                    <p>
                                        DISCAILMER : This is only Gas charging charges , If breakdown / repair required rates may vary as per standard charges in the market
                                    </p>
                                </div>
                            </div>
                        </div>
