...
export default function fanmotorinstallationPageOne() {
    return (
        <>
            <SEO pageTitle={"Fan Motor Installation"} />
            <HeaderOne />
            <Breadcrumb
                    ...
                    <div className="row">
                        <div className="innerpage-whiteboxs main-timeline">
                            <div className="text-center mb-12" style={{ paddingBottom: '60px' }}>
                                ...
                                <h2 className="text-3xl font-bold">FAN MOTOR INSTALLATION SERVICES</h2>
                                <p className="text-gray-600 mt-2">Fan Motor Replacement ! Process of supply / repair & installation of the fan motor in Air conditioner</p>
                            </div>
                            <div>
                                <Onetimeservice />
                                <div className="mb-12 text-center italic" style={{ paddingTop: '60px', fontSize: 'small' }}>
                                    <p>
                                        DISCAILMER : This is only Fan motor supply / repair charges , If breakdown / repair required rates may vary as per standard charges in the market
                                    </p>
                                </div>
                            </div>
                        </div>
