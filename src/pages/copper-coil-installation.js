...
export default function coppercoilinstallationPageOne() {
    return (
        <>
            <SEO pageTitle={"Copper Coil Installation"} />
            <HeaderOne />
            <Breadcrumb
                heading="Copper Coil Installation"
                currentPage="Copper Coil Installation"
                backgroundImage="/assets/images/backgrounds/copper-coil.jpg"
            />
                    ...
                    <div className="row">
                        <div className="innerpage-whiteboxs main-timeline">
                            <div className="text-center mb-12" style={{ paddingBottom: '60px' }}>
                                ...
                                <h2 className="text-3xl font-bold">COPPER COIL INSTALLATION SERVICES</h2>
                                <p className="text-gray-600 mt-2">Copper Coil Replacement ! Process of supply & installation of the copper coils in Air conditioner</p>
                            </div>
                            <div>
                                <Onetimeservice />
                                <div className="mb-12 text-center italic" style={{ paddingTop: '60px', fontSize: 'small' }}>
                                    <p>
                                        DISCAILMER : This is only Copper coil replacement charges , If breakdown / repair required rates may vary as per standard charges in the market
                                    </p>
                                </div>
                            </div>
                        </div>
