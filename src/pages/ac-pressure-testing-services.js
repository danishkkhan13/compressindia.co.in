...
export default function AcpressuretestservicesPageOne() {
    return (
        <>
            <SEO pageTitle={"AC Pressure Testing Services"} />
            <HeaderOne />
            <Breadcrumb
                    ...
                    <div className="row">
                        <div className="innerpage-whiteboxs main-timeline">
                            <div className="text-center mb-12" style={{ paddingBottom: '60px' }}>
                                ...
                                <h2 className="text-3xl font-bold">AC PRESSURE TESTING SERVICES</h2>
                                <p className="text-gray-600 mt-2">Leak Testing ! Process of finding leakage in the copper tubes to prevent refrigerant gas leakage issue</p>
                            </div>
                            <div>
                                <Onetimeservice />
                                <div className="mb-12 text-center italic" style={{ paddingTop: '60px', fontSize: 'small' }}>
                                    <h6>
                                        DISCAILMER : This is only Pressure tasting charges , If breakdown / repair required rates may vary as per standard charges in the market
                                    </h6>
                                </div>
                            </div>
                        </div>
